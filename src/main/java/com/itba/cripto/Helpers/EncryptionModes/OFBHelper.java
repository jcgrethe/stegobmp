...
public class OFBHelper implements EncriptionMode {

    private static byte[] key;
    private static SecretKeySpec secretKey;
    private static String Mode = Constants.CosntantsValues.OFB.toUpperCase();
    ...
    public String encrypt(String strToEncrypt, String secret, String scheme)
    {
        ...
        {
            String mode;
            if(scheme.compareTo(Constants.CosntantsValues.DES) == 0)
